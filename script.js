    ...
    var dayone = $("<div>");
        ...
        var dayonecard= $("<div>").addClass("card mr-5 bg-primary text-white");
            // populate card with content 
                ...
                // var symbolone = $("<img>").attr("src",response.list[1].weather[0].icon);
                // symbolone.attr("alt", "a symbol for today's weather");
                // p of temp
    ...
    var daytwo = $("<div>");
        ...
        var daytwocard= $("<div>").addClass("card mr-5 bg-primary text-white");
            // populate card with content 
              ...
              // img of the weather symbol
            //   var symboltwo = $("<img>").attr("src",response.list[2].weather[0].icon);
            //   symboltwo.attr("alt", "a symbol for today's weather");
              // p of temp
    ...
    var daythree = $("<div>");
        ...
        var daythreecard= $("<div>").addClass("card mr-5 bg-primary text-white");
            // populate card with content 
                ...
                // img of the weather symbol
                // var symbolthree = $("<img>").attr("src",response.list[3].weather[0].icon);
                // symbolthree.attr("alt", "a symbol for today's weather");
                // p of temp
    ...
    var dayfour = $("<div>");
        ...
        var dayfourcard= $("<div>").addClass("card mr-5 bg-primary text-white");
            // populate card with content 
                ...
                // img of the weather symbol
                // var symbolfour = $("<img>").attr("src",response.list[4].weather[0].icon);
                // symbolfour.attr("alt", "a symbol for today's weather");
                // p of temp
    ...
    var dayfive = $("<div>");
        ...
        var dayfivecard= $("<div>").addClass("card mr-5 bg-primary text-white");
            // populate card with content 
                ...
                // img of the weather symbol
                // var symbolfive = $("<img>").attr("src" ,response.list[5].weather[0].icon);
                // symbolfive.attr("alt", "a symbol for today's weather");
                // p of temp
